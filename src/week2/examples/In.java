 ...
 *  testScanner.java</a></tt> (NB: Java 6u23 and earlier uses only \r, \r, \r\n).
 *
...
public final class In {
    ...
    // is held by the testScanner's delimiter between calls
   ...
   /**
    ...
    /**
     * Create an input stream from a given testScanner source; use with
     * <tt>new testScanner(String)</tt> to read from a string.
     * <p>
     * Note that this does not create a defensive copy, so the
     * testScanner will be mutated as you read on.
     */
   ...
   /**
    ...
    public String readAll() {
        ...
        // not that important to reset delimeter, since now testScanner is empty
